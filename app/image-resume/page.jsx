...
export default function BasicResume() {
  ...
  const handleSubmit = (values) => {
    ...
    router.push(`/pic-resume-ready?${new URLSearchParams(formDataObj).toString()}`);
  };

  const handleClear = (resetForm) => {
    resetForm();
    // setImagePreview(null); // Uncomment this line if image preview functionality is added back
  };
